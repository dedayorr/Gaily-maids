...
const EmbraceHealth = () => {
  ...
  return (
    <div
      className={`faq my-[10%] h-[300px] flex justify-center items-center text-center  bg-[#813ec94e] lg:h-[600px] lg:justify-normal`}
    >
      {" "}
      <Image
      ...
      <div className="bg-embrace relative flex flex-col gap-[30px] w-full">
        ...
        <button
          onClick={openModal}
          className="lg:hidden border border-[#823ec9] p-[3%] text-[#823ec9] w-[60%] mx-auto"
        >
