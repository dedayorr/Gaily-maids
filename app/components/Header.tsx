    ...
    return (<>
        ...
        <div className="absolute w-[100%] h-[560px] top-[90px] right-0 left-0 bg-[#0000007b] md:h-[600px] md:top-[105px]"><div className='bg-red- mt-[23%] py-[10%] text-white tracking-widest px-[5%] flex flex-col gap-[20px] '>
            ...
            <div className='bg-[#2f1e42] text-white flex items-center justify-between h-[30px] px-[3%]'>
                ...
                <a className='text-[11px]' href='tel:+1-872-235-7202'> +1-872-235-7202 </a>
            ...
            <div className='sticky top-0 flex justify-between items-center px-[5%] bg-white h-[60px]'>
                ...
                <div className='md:hidden' onClick={toggleMenu}>
                    {!navOpen ? <GiHamburgerMenu className='text-2xl' /> : <FaTimes className='text-2xl' />}
                </div>
                ...
                <div className='fixed top-0 w-[87%] h-full bg-white'>
                    <Accordion className='md:hidden border-none flex flex-col gap-[25px] pt-[65px] px-[5%]'>
                        <Accordion.Panel>
                            ...
                            <Accordion.Content >
                                <ul className='flex flex-col ml-[6%] gap-5 font-light text-[#823ec9]'>
                                    <li><Link href="">Apartment Cleaning</Link></li>
                                    <li> <Link href="">House Cleaning</Link></li>
                                    <li><Link href="">Detailed Cleaning </Link></li>
                                    <li> <Link href="">Holiday Cleaning </Link></li>
                                </ul>
                        ...
                        <Accordion.Panel>
                            ...
                            <Accordion.Content >
                                <ul className='flex flex-col ml-[6%] gap-5 font-light text-[#823ec9]'>
                                    <li><Link href="">Bathroom Cleaning</Link></li>
                                    <li> <Link href="">Bedroom Cleaning</Link></li>
                                    <li><Link href="">Kitchen Cleaning </Link></li>
                                    <li> <Link href="">Laundry Room Cleaning </Link></li>
                                    <li> <Link href="">Dinning Room Cleaning </Link></li>
                                    <li> <Link href="">Living Room Cleaning </Link></li>
                                </ul>
                            </Accordion.Content>
                        </Accordion.Panel>
                        <Accordion.Panel>
                            ...
                            <Accordion.Content>
                                <ul className='flex flex-col ml-[6%] gap-5 font-light text-[#823ec9]'>
                                    <li><Link href="">Afforable Cleaning</Link></li>
                                    <li> <Link href="">Best Cleaning Service</Link></li>
                                    <li><Link href="">Custom Cleaning </Link></li>
                    ...
                    <Link href="" ><button className='ml-[5%] mt-[15%] text-[20px] italic text-[#5f2b96] underline'>Request & Estimate</button></Link>
